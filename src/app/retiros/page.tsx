...
const mockWithdrawals = [
  { id: 1, amount: 1000, status: "completed", date: "2024-01-10", txHash: "0x1234...abcd", method: "USDC" },
  { id: 2, amount: 500, status: "pending", date: "2024-01-15", txHash: null, method: "Bank Transfer" },
  { id: 3, amount: 2500, status: "completed", date: "2023-12-28", txHash: "0x5678...efgh", method: "USDC" },
        ...
        <main className="p-8 max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Solicita y gestiona tus retiros de fondos</p>
              </div>
            </div>
          </div>
          ...
          {!isKYCVerified && (
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-2xl p-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-yellow-900 dark:text-yellow-100">KYC Requerido</h3>
                  <p className="text-yellow-700 dark:text-yellow-300">Debes verificar tu identidad antes de poder retirar fondos.</p>
                </div>
                <a
                  href="/kyc"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Mínimo: $10 · Máximo: ${availableBalance.toLocaleString()}
                    </p>
                  </div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-4 text-center">
                  ⚡ Retiros en USDC son instantáneos. Transferencias bancarias toman 2-3 días hábiles.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Historial de Retiros</h2>
                
                <div className="space-y-3">
                  {mockWithdrawals.map((withdrawal) => (
                    <div key={withdrawal.id} className="flex items-center justify-between p-4 rounded-xl bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-3">
                            ...
                            <span className={`text-xs px-2 py-1 rounded-full font-medium ${
                              withdrawal.status === "completed" ? "bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300" :
                              withdrawal.status === "pending" ? "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300" :
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">USDC directo a tu wallet</p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                  <div className="text-3xl mb-2">🔒</div>
                  <h4 className="font-bold text-gray-900 dark:text-white mb-1">Seguro</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Transacciones verificadas</p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                  <div className="text-3xl mb-2">💰</div>
