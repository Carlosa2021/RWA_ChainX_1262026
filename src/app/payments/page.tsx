...
export default function PaymentsPage() {
  ...
  const { hasAccess, showUpgradePrompt, upgradePromptOpen, closeUpgradePrompt, requiredFeature } =
    useFeatureGuard('payEnabled', 'Pay');
          ...
          <div className="p-6">
            ...
            <div className="bg-linear-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="bg-white/20 px-3 py-1 rounded-full text-sm font-medium">DEMO</span>
              </div>
            ...
            {!paymentCompleted ? (
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-semibold dark:text-white">
                              €{selectedProperty.pricePerToken.toLocaleString('es-ES')}
                            </span>
                          </div>
                          <div className="border-t dark:border-gray-700 pt-2 flex justify-between font-bold text-blue-600 dark:text-blue-400">
                            ...
                            <span>€{totalInvestment.toLocaleString('es-ES')}</span>
                          </div>
              ...
              <div className="max-w-2xl mx-auto">
                <div className="bg-white rounded-xl shadow-lg p-8 text-center">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 mb-4">¡Inversión Completada!</h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="p-6 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-blue-700">
                    Los usuarios pueden pagar con fiat y recibir tokens directamente, sin necesidad
                    de convertir manualmente a crypto.
                  </p>
                </div>
                ...
                <div className="p-6 bg-purple-50 rounded-lg">
                  ...
                  <p className="text-sm text-purple-700">
                    Acepta pagos de todo el mundo con múltiples monedas y métodos de pago
                    regionales.
                  </p>
                </div>
