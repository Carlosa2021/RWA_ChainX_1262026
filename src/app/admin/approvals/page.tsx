...
const REQUESTS: readonly ApprovalRequest[] = [
  ...
  },
  {
    ...
    payload: { tenant: 'meridian', action: 'branding_update', requestedBy: 'Thomas Weber' },
  },
  {
    id: 'APR-2026-004',
    ...
    entity: 'compliance@meridian-capital.ch',
    category: 'Users',
    priority: 'High',
    status: 'Pending',
    isoDaysAgo: 1,
    ...
    payload: {
      user: 'compliance@meridian-capital.ch',
      from: 'READ_ONLY',
