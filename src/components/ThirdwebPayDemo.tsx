...
export default function ThirdwebPayDemo({
  ...
  const totalWithFees = investmentAmount * 1.029 + 0.30; // Ejemplo con tarjeta
      ...
      <div className={`bg-white rounded-xl p-6 ${className}`}>
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Para usar thirdweb Pay, primero conecta tu billetera
          </p>
        </div>
      </div>
    );
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-2 flex justify-between text-sm text-gray-600">
                <span>Mínimo: €{minInvestment.toLocaleString()}</span>
                <span>Máximo: €{maxInvestment.toLocaleString()}</span>
              </div>
              <div className="mt-2 p-3 bg-blue-50 rounded-lg">
                ...
                <p className="text-xs text-blue-600 mt-1">
                  Precio por token: €{propertyPrice.toLocaleString()}
                </p>
              </div>
            </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">€{(totalWithFees - investmentAmount).toFixed(2)}</span>
                  </div>
            ...
            <div className="bg-green-50 rounded-lg p-4 text-left">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-green-700">€{investmentAmount.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-sm font-medium text-blue-900 mb-1">
                Pagos Seguros con thirdweb
              </h4>
              <p className="text-xs text-blue-700">
                Todos los pagos están protegidos con encriptación de nivel bancario y son procesados de forma segura a través de la infraestructura de thirdweb.
              </p>
            </div>
          </div>
        </div>
