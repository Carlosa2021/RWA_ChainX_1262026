...
export default function ThirdwebVaultDemo({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'deposit' | 'strategies' | 'analytics'>(
    'overview'
  );
  ...
  useEffect(() => {
    const totalTVL = mockAssets.reduce(
      (sum, asset) => sum + asset.vaultBalance * asset.priceUSD,
      0
    );
  ...
  const simulateVaultAction = async (
    action: 'deposit' | 'withdraw' | 'stake' | 'unstake',
    amount: number
  ) => {
    ...
    return (
      <div className={`bg-white rounded-xl p-6 ${className}`}>
        <div className="text-center">
          ...
          <p className="text-gray-600">Para usar thirdweb Vault, primero conecta tu billetera</p>
        </div>
      </div>
    );
  }
    ...
    <div className={`bg-white rounded-xl overflow-hidden ${className}`}>
      ...
      <div className="bg-linear-to-r from-indigo-600 to-purple-600 p-6 text-white">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="bg-white/20 px-2 py-1 rounded-full text-xs font-medium">SECURE</span>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white/10 rounded-lg p-3">
            ...
            <div className="text-lg font-bold">${vaultStats.totalTVL.toLocaleString('es-ES')}</div>
          </div>
          <div className="bg-white/10 rounded-lg p-3">
          ...
          {[
            ...
            return (
              <button
                key={tab.id}
                onClick={() =>
                  setActiveTab(tab.id as 'overview' | 'deposit' | 'strategies' | 'analytics')
                }
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-indigo-600">
                        {asset.vaultBalance} {asset.symbol}
                      </div>
                    </div>
                    <div>
                  ...
                  {asset.isStakeable && (
                    <div className="mt-3 flex items-center gap-2 text-sm">
                      ...
                      <span className="text-gray-600">
                        Staked: {asset.stakedBalance} {asset.symbol}
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-green-50 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    onClick={() =>
                      depositAmount && simulateVaultAction('deposit', parseFloat(depositAmount))
                    }
              ...
              <div className="bg-red-50 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    onClick={() =>
                      withdrawAmount && simulateVaultAction('withdraw', parseFloat(withdrawAmount))
                    }
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="text-right">
                      ...
                      <span
                        className={`text-xs px-2 py-1 rounded-full ${getRiskColor(strategy.risk)}`}
                      >
                        {strategy.risk} Risk
                      </span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                    <div>
                      ...
                      <div className="font-medium">
                        ${strategy.minDeposit.toLocaleString('es-ES')}
                      </div>
                    </div>
                    <div>
                      <div className="text-gray-500">TVL</div>
                      <div className="font-medium">
                        ${strategy.currentTVL.toLocaleString('es-ES')}
                      </div>
                    </div>
                    <div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-indigo-700">
                All assets are protected by multi-signature wallets, time-locks, and undergo regular
                security audits. Smart contracts are verified and open-source.
              </p>
            </div>
          </div>
        </div>
