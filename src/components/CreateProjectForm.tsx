                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div>
                        ...
                        <span className="font-mono font-bold">{formData.symbol}</span>
                      </div>
                      <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div>
                        ...
                        <span className="font-bold text-green-600">
                          €{Number(formData.totalValue).toLocaleString('es-ES')}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-600 dark:text-gray-400">Precio/Token:</span>{' '}
                        <span className="font-bold">€{formData.pricePerToken}</span>
                      </div>
                      <div>
                        <span className="text-gray-600 dark:text-gray-400">Máx. Tokens:</span>{' '}
                        <span className="font-bold">
                          {Number(formData.maxTokens).toLocaleString('es-ES')}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-600 dark:text-gray-400">Stablecoin:</span>{' '}
                        <span className="font-medium">
                          {STABLECOINS.find((c) => c.value === formData.stablecoin)?.symbol}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div>
                        ...
                        <span className="font-medium">
                          {formData.propertyImages.length} archivo(s)
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-600 dark:text-gray-400">Documentos:</span>{' '}
                        <span className="font-medium">
                          {formData.legalDocuments.length} archivo(s)
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {formData.duration && (
                        <div>
                          ...
                          <span className="font-medium">{formData.duration} años</span>
                        </div>
                      )}
                    </div>
                  </div>
